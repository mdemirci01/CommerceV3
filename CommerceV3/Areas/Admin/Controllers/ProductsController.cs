...
namespace CommerceV3.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Slug,Description,OldPrice,Price,Quantity,IsInStock,IsPublished,IsNew,ShippingPriceCityWide,ShippingPriceCountryWide,ShippingPriceWorldWide,SupplierId,BrandId,CreatedBy,CreateDate,UpdatedBy,UpdateDate")] Product product)
        {
